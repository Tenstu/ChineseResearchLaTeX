...
<img src="logo/logo-compressed.png" alt="项目 Logo" width="200"/>
...
<h3><strong>🤝 打造最适合中国研究者的科研文档 AI Agent，让天下没有难写的国自然标书、SCI 论文、毕业论文、学术简历！🚀</strong></h3>
...
<h3><strong>2026年国自然基金申请基本已经收尾。v4是为2027年及以后的国自然申请做准备。如果您有2026年申请的需要，请使用v3。不便之处，敬请谅解！</strong></h3>
...
如果您确定使用本项目，必须先拥有足够的AI算力。 具体见我的博客文章： [AI入门系列 如何获得vibe coding相关的AI算力 - Bensz](https://blognas.hwb0307.com/ai/7008)。
...
> 🛠️ **开发者协作**：如需贡献代码、模板或脚本，请先阅读 [开发者贡献规范](docs/developer-contribution-guide.md)。本项目默认采用“先提 Issue、获维护者确认后再提 PR”的流程。

欢迎关注 [Bensz Channel](https://channel.hwb0307.com)，与其他用户交流经验、分享心得！无论您是对以下哪个话题感兴趣，都欢迎扫码加入：
...
- [合集·国自然与Vibe Coding](https://space.bilibili.com/24478261/lists/7373060)
- [合集·Bensz Vibe Coding实用教程](https://space.bilibili.com/24478261/lists/7362584?type=season)
...
> 当前同步源：`huangwb8/ChineseResearchLaTeX@v4.0.16`，发布时间：2026-06-05 18:40（UTC+8）。
...
|------|------|--------|-------------|
| [青年 C](projects/NSFC_Young/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_Young-v4.0.16.zip)（2.24 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_Young-Overleaf-v4.0.16.zip)（7.85 MB） |
| [面上](projects/NSFC_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_General-v4.0.16.zip)（0.96 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_General-Overleaf-v4.0.16.zip)（7.22 MB） |
| [地区](projects/NSFC_Local/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_Local-v4.0.16.zip)（2.26 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/NSFC_Local-Overleaf-v4.0.16.zip)（7.90 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [广东省面上](projects/GDNSF_General/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/GDNSF_General-v4.0.16.zip)（0.14 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/GDNSF_General-Overleaf-v4.0.16.zip)（30.1 MB） |

### SCI 论文模板

> 公共包 + 示例项目已落地，支持 PDF / DOCX 双输出。
> SCI 模板通常需要按期刊规范或既有 Word 稿件做个性化定制；如有这类需求，建议提交 [SCI 论文模板定制需求](https://github.com/huangwb8/ChineseResearchLaTeX/issues/new?template=paper-template-customization.yml)。

| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [paper-coverletter-01](projects/paper-coverletter-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/paper-coverletter-01-v4.0.16.zip)（0.30 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/paper-coverletter-01-Overleaf-v4.0.16.zip)（0.01 MB） |
| [paper-sci-01](projects/paper-sci-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/paper-sci-01-v4.0.16.zip)（0.38 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/paper-sci-01-Overleaf-v4.0.16.zip)（0.02 MB） |

### 学位论文 / 博士后模板

> 公共包 + 示例项目已落地，支持 PDF 输出与像素级验收。
> 毕业论文/博士后模板通常需要按学校、学院或类型规范做个性化定制；如有这类需求，建议提交 [毕业论文模板定制需求](https://github.com/huangwb8/ChineseResearchLaTeX/issues/new?template=thesis-template-customization.yml)。

| 模板 | 院校 | 类型 | 标准包 | Overleaf 包 |
|------|------|------|--------|-------------|
| [thesis-ahnu-master](projects/thesis-ahnu-master/) | 安徽师范大学 | 硕士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-ahnu-master-v4.0.16.zip)（0.34 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-ahnu-master-Overleaf-v4.0.16.zip)（0.05 MB） |
| [thesis-just-bachelor](projects/thesis-just-bachelor/) | 江苏科技大学 | 学士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-just-bachelor-v4.0.16.zip)（1.40 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-just-bachelor-Overleaf-v4.0.16.zip)（0.58 MB） |
| [thesis-nju-master](projects/thesis-nju-master/) | 南京大学 | 硕士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-nju-master-v4.0.16.zip)（1.86 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-nju-master-Overleaf-v4.0.16.zip)（1.24 MB） |
| [thesis-smu-master](projects/thesis-smu-master/) | 南方医科大学 | 硕士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-smu-master-v4.0.16.zip)（0.54 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-smu-master-Overleaf-v4.0.16.zip)（0.18 MB） |
| [thesis-smu-postdoc](projects/thesis-smu-postdoc/) | 南方医科大学 | 博士后 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-smu-postdoc-v4.0.16.zip)（0.41 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-smu-postdoc-Overleaf-v4.0.16.zip)（0.08 MB） |
| [thesis-sysu-doctor](projects/thesis-sysu-doctor/) | 中山大学 | 博士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-sysu-doctor-v4.0.16.zip)（0.55 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-sysu-doctor-Overleaf-v4.0.16.zip)（0.63 MB） |
| [thesis-ucas-doctor](projects/thesis-ucas-doctor/) | 中国科学院大学 | 博士 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-ucas-doctor-v4.0.16.zip)（0.41 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/thesis-ucas-doctor-Overleaf-v4.0.16.zip)（0.53 MB） |
...
| 模板 | 状态 | 标准包 | Overleaf 包 |
|------|------|--------|-------------|
| [cv-01](projects/cv-01/) | ✅ 已发布 | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/cv-01-v4.0.16.zip)（1.99 MB） | [下载](https://github.com/huangwb8/ChineseResearchLaTeX/releases/download/v4.0.16/cv-01-Overleaf-v4.0.16.zip)（38.6 MB） |
<!-- TEMPLATE-LIST:END -->
...
- 由于在本地使用 Vibe Coding 的体验很好，因此**不推荐**在 Overleaf 等在线平台使用本模板。但本项目**仍会持续支持 Overleaf 平台**，以满足一些小众用户的需求。
